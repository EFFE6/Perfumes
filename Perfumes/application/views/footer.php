...
<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					...
					</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Techniche's</a> &amp; distributed by <a href="https://themewagon.com" target="_blank">Anmer</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<!--===============================================================================================-->
	<script src="<?php echo base_url('vendor/parallax100/parallax100.js'); ?>"></script>
	<script>
		$('.parallax100').parallax100();
	</script>
	<!--===============================================================================================-->
	<script src="<?php echo base_url('vendor/MagnificPopup/jquery.magnific-popup.min.js'); ?>"></script>
	<script>
